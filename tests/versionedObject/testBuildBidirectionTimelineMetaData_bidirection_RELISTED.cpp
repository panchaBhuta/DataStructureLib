...
//       ANDHRAPAP,ANDHRA PAPER LIMITED,EQ,13-MAY-2004,10,1,INE435A01028,10
    ...
    dsvo::DataSet<COMPANYMETAINFO_TYPE_LIST> companyRecordRelistedExpected {firstMeta, companyInfoLatest};
...
//       ANDHRAPAP,ANDHRA PAPER LIMITED,EQ,13-MAY-2004,10,1,INE435A01028,10
    ...
    unittest::ExpectEqual(dsvo::DataSet<COMPANYMETAINFO_TYPE_LIST>, companyRecordFirstExpected,
...
//  28-Oct-2023,+marketLotchange,ANDHRAPAPER,ANDHRA PAPER LIMITED,EQ,10,5,INE546B12139,10,LISTING
    ...
    dsvo::DataSet<COMPANYMETAINFO_TYPE_LIST> companyRecordEightExpected {lotChgMetaExp, companyInfoEigth};
    ...
    unittest::ExpectEqual(bool, true, companyRecordEightActual != vo.getDatasetLedger().cend()); // has dsvo::DataSet<COMPANYMETAINFO_TYPE_LIST>

    unittest::ExpectEqual(dsvo::DataSet<COMPANYMETAINFO_TYPE_LIST>, companyRecordEightExpected,
