...
//       ANDHRAPAP,ANDHRA PAPER LIMITED,EQ,13-MAY-2004,10,1,INE435A01028,10
    ...
    insertResult = vo.insertVersion(t_listingDate(std::chrono::year(int(2022)), std::chrono::January, std::chrono::day(unsigned(12))),
                                    companyRecordRelistedExpected);
    unittest::ExpectEqual(bool, true, insertResult);
    ...
    std::string voStrBidirection =
      ...
      "28-Oct-2023,ANDHRAPAPER,ANDHRA PAPER LIMITED,EQ,10,5,INE546B12139,10,LISTING\n";
...
//       ANDHRAPAP,ANDHRA PAPER LIMITED,EQ,13-MAY-2004,10,1,INE435A01028,10
    ...
    unittest::ExpectEqual(dsvo::DataSet<COMPANYINFO_TYPE_LIST>, companyRecordFirstExpected,
...
//  NOTE: the row below is not a versioned information, but info from EQUITY_L.csv
//  12-Jan-2022,EQUITY_L,ANDHRAPAPER,ANDHRA PAPER LIMITED,EQ,10,1,INE546B12139,10,LISTING
...
//  ",,,0,5,,0,"
//  28-Oct-2023,+marketLotchange,ANDHRAPAPER,ANDHRA PAPER LIMITED,EQ,10,5,INE546B12139,10,LISTING
    t_companyInfo companyInfoEigth = converter::ConvertFromString<COMPANYINFO_TYPE_LIST>::ToVal(
      "ANDHRAPAPER,ANDHRA PAPER LIMITED,EQ,10,5,INE546B12139,10,LISTING"    );
