...
{
  {
    ...
    TEST_WITH_METADATA(dsvo::MetaDataSource lotChgMeta("marketLotchange" COMMA dsvo::MetaDataSource::eDataBuild::FORWARD));
  ...
  std::string voStrForward =
    ...
    "05-Mar-2020," TEST_WITH_METADATA("+symbolchange,") "ANDHRAPAP,ANDHRA PAPER LIMITED,EQ,10,1,INE435A01028,10,LISTED\n"                 // FORWARD
    "07-Apr-2021," TEST_WITH_METADATA("+marketLotchange,") "ANDHRAPAP,ANDHRA PAPER LIMITED,EQ,10,2,INE435A01028,10,LISTED\n";             // FORWARD
